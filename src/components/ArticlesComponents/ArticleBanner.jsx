import Services3Bg from "../../assets/images/articlesbanner.png";
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0">
              <h2 className="text-8xl font-light font-neuton pt-52 tracking-tight text-white sm:text-6xl increase">
                Read Our Today's<br></br>
                Essential
                <span className="border-b-4 border-[#E8E753]"> Reads</span>
              </h2>
            </div>
          </div>
