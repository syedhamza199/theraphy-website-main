          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0">
              ...
              <h2 className="text-8xl font-light font-neuton tracking-tight text-white sm:text-6xl">
                Theraphy for How <br></br>
                We Live{" "}
                <span className="border-b-4 border-[#E8E753]">Today</span>
              </h2>
            </div>
          </div>

          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto mt-20 grid max-w-xl grid-cols-1 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3 custom">
              <img
                src={Eclipses}
