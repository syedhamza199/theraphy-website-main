import Services4Bg from "../../assets/images/service4bg.png";
import Eclipses from "../../assets/images/eclipses.png";

const Service3Banner = () => {
  return (
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <h2 className="text-8xl font-light font-neuton tracking-tight text-white sm:text-6xl increase">
              Medication <br></br>
              <span className="border-b-4 border-[#E8E753]">management</span>
            </h2>
          </div>
        </div>
