import Services1Bg from "../../assets/images/service1bg.png";
    ...
    <>
      <div className="relative isolate overflow-hidden py-24 sm:py-32">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0">
              ...
              <h2 className="text-8xl font-light font-neuton tracking-tight text-white sm:text-6xl">
                Individual <br></br>
                <span className="border-b-4 border-[#E8E753]">Counseling</span>
              </h2>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div
              className="mx-auto mt-20 grid max-w-xl grid-cols-1 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3 service1"
              id="service1"
            >
              <img
                src={Eclipses}
