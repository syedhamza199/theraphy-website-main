import Team11 from "../../assets/images/slider3.png";
import Team12 from "../../assets/images/slider2.png";
import Team13 from "../../assets/images/slider1.png";
            ...
            {visibleTeams.map((team) => (
              ...
              >
                <div className="flex flex-col bg-[#b6ccb1] p-10 rounded-lg custom-w">
                  ...
                  <div className="border-b-4 border-[#E8E753]"></div>
                </div>
              </motion.div>
            ))}
            <img
